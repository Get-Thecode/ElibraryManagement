                     ...
                     <div class="col">
                        <center>
                           <h4>Your Profile</h4>
                            ...
                            <asp:Label class="badge badge-info badge-pill" ID="Label1" runat="server" Text="Label"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox10" runat="server" placeholder="Email ID" TextMode="Password" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
